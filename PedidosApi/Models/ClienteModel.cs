...
namespace PedidosApi.Models
{
    public class ClienteModel
    {
        ...
        [MaxLength(80, ErrorMessage = "O nome completo não pode exceder o limite de 80 caracteres!")]
        ...
        [MaxLength(256, ErrorMessage = "O endereço de email não pode exceder o limite de 256 caracteres!")]
